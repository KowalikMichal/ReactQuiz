		...
		return (
			...
			<Grid >
				<Row className="wrapper">
					<Tabs id="GamesTab" onSelect={this.handleSelect} activeKey={this.state.key}>
						<Tab eventKey={1} title="🏠" disabled>
							<div className="text-center">
								...
								<Button onClick={() => this.handleSelect(2)}>Game settings</Button>
							</div>
						</Tab>
						<Tab eventKey={2} title="⚙️" disabled>
						<div className="text-center">
								...
								<Button bsStyle="success" onClick={() => this.handleSelect(3)} >Let's play</Button>
							</div>
						</Tab>
						<Tab eventKey={3} title="🕹️" disabled>
							<QuizQuestion passedVal={this.state} handleSelect={this.handleSelect}/>
						</Tab>
					</Tabs>
				</Row>
			</Grid>
